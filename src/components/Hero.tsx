...
import { Download, DownloadIcon, Send } from "lucide-react";
...
const Hero = () => {
  return (
    <section
      ...
      bg-hero bg-no-repeat bg-bottom 
     bg-cover dark:bg-none"
    >
      <div className="container mx-auto">
        <div className="flex justify-between gap-x-8">
          ...
          >
            ...
            <h1 className="h1 mb-4">Hello, my name is Rakshith Raj S</h1>
            <p className="subtitle max-w-[490px] mx-auto xl:mx-0 mb-12">
